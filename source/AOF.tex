%
% AOF.tex
% Main LaTeX document for formatting AOF
%
...
\usepackage[colorlinks=true,linkcolor=ao-purple]{hyperref} % /usr/share/doc/texlive-doc/latex/hyperref/hyperref.pdf
    %       http://www.tug.org/applications/hyperref/manual.html
    % /usr/share/doc/texlive-doc/latex/hyperref/hyperref.pdf
%\usepackage{url} % /usr/share/doc/texlive-doc/latex/url/url.pdf % Use href
\graphicspath{{./images/}}
...
%%% AOF PAGE STYLE %%%
\makepagestyle{aofstyle}
\pagestyle{aofstyle}
\makeevenhead{aofstyle}{}{\hspace{2em}\itshape\small\leftmark}{}
\makeoddhead{aofstyle}{}{\scshape\small\rightmark}{}
\makeevenfoot{aofstyle}{}{\hspace{2em}\thepage}{}
\makeoddfoot{aofstyle}{}{\thepage}{}
%%% END AOF PAGE STYLE %%%

%%% AOFSKI CHAPTER STYLE %%%
\makechapterstyle{aofski}{%
...
%%% CHAPTER STYLE %%%
\chapterstyle{aofski} % defined in preamble
\def\topblockvspace{0.11}
%%% END CHAPTER STYLE %%%

%%% CHAPTER CONFIG %%%
\newcommand{\chapterheader}{Aleph Objects Firewall}
...
\chapterconf{Introduction}{Introduction}{Aleph Objects Network}
...
\chapterconf{pfsense}{pfSense}{Firewall.}
\chapterconf{iptables}{iptables}{Stop.}
%\chapterconf{Authentication}{Authentication}{Who?}
%\chapterconf{Routers}{Routers}{There.}
%\chapterconf{Analytics}{Analytics}{Wha?}
\chapterconf{Hardware}{Hardware}{Purchase Order}
\chapterconf{Switches}{Switches}{Here.}
\chapterconf{OS}{OS}{Free Operating Systems}
