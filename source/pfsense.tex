...
\begin{figure}[h!]
\begin{center}
\includegraphics[keepaspectratio=true,height=0.50\textheight,width=0.75\textwidth,angle=0]{pfsense-sys-adv-net}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[keepaspectratio=true,height=0.80\textheight,width=0.90\textwidth,angle=0]{pfsense-sys-adv-misc.png}
 \caption{pfSense Menu: System, Advanced, Miscellaneous}
 \label{fig:pfsense-sys-adv-misc}
\end{center}
\end{figure}

Miscellaneous configuration, such as hardware accelerated crypto.
...
\begin{figure}[h!]
\begin{center}
\includegraphics[keepaspectratio=true,height=0.50\textheight,width=0.75\textwidth,angle=0]{pfsense-sys-adv-notif.png}
